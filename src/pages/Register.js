...
import "../components/style/css/register.css";
                    ...
                    <div className="data-info-wrap">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="text-align-left">
                                    <input className="casenb" placeholder="입력하세요"></input> 
                                </td>
                                <th>
                                  <strong>사건접수</strong>
                                </th>
                      ...
                      <div class="print-area-content" data-print-value="2">
                        ...
                        <table class="table auction-iiprogress">
                          ...
                          <tbody>
                            <tr class="point">
                              <td><input className="casenb" placeholder="입력하세요"></input></td>
                              <td><input className="casenb" placeholder="입력하세요"></input></td>
                              <td class="text-align-right"><input className="casenb" placeholder="입력하세요"></input></td>
                              <td><input className="casenb" placeholder="입력하세요"></input></td>
                            </tr>
                            <tr>
